...
const double _kMinCircularProgressIndicatorRoundedSize = 36.0;
...
/// see [CircularProgressIndicatorRounded].
///
/// See also:
///
...
/// See also:
///
///  * [CircularProgressIndicatorRounded], which shows progress along a circular arc.
...
///
/// {@tool dartpad}
/// This sample shows the creation of a [CircularProgressIndicatorRounded] with a changing value.
/// When toggling the switch, [CircularProgressIndicatorRounded] uses a determinate value.
/// As described in: https://m3.material.io/components/progress-indicators/overview
///
...
class _CircularProgressIndicatorRoundedState extends State<CircularProgressIndicatorRounded> with SingleTickerProviderStateMixin {
  ...
  Widget _buildMaterialIndicator(BuildContext context, double headValue, double tailValue, double offsetValue, double rotationValue) {
    final ProgressIndicatorThemeData defaults = Theme.of(context).useMaterial3
      ? _CircularProgressIndicatorRoundedDefaultsM3(context)
      : _CircularProgressIndicatorRoundedDefaultsM2(context);
    ...
    return widget._buildSemanticsWrapper(
      ...
      child: Container(
        constraints: const BoxConstraints(
          minWidth: _kMinCircularProgressIndicatorRoundedSize,
          minHeight: _kMinCircularProgressIndicatorRoundedSize,
        ),
        child: CustomPaint(
...
class _RefreshProgressIndicatorPainter extends _CircularProgressIndicatorRoundedPainter {
...
///  * [RefreshIndicator], which automatically displays a [CircularProgressIndicatorRounded]
///    when the underlying vertical scrollable is overscrolled.
class RefreshProgressIndicator extends CircularProgressIndicatorRounded {
  ...
  const RefreshProgressIndicator({
    ...
    super.color,
    super.valueColor,
    super.strokeWidth = defaultStrokeWidth, // Different default than CircularProgressIndicatorRounded.
    super.semanticsLabel,
    super.semanticsValue,
  });
  ...
  @override
  State<CircularProgressIndicatorRounded> createState() => _RefreshProgressIndicatorState();
}

class _RefreshProgressIndicatorState extends _CircularProgressIndicatorRoundedState {
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        return _buildMaterialIndicator(
          ...
          1.05 * _CircularProgressIndicatorRoundedState._strokeHeadTween.evaluate(_controller),
          _CircularProgressIndicatorRoundedState._strokeTailTween.evaluate(_controller),
          _CircularProgressIndicatorRoundedState._offsetTween.evaluate(_controller),
          _CircularProgressIndicatorRoundedState._rotationTween.evaluate(_controller),
        );
      },
    );
  }
...
class _CircularProgressIndicatorRoundedDefaultsM2 extends ProgressIndicatorThemeData {
  _CircularProgressIndicatorRoundedDefaultsM2(this.context);
...
class _CircularProgressIndicatorRoundedDefaultsM3 extends ProgressIndicatorThemeData {
  _CircularProgressIndicatorRoundedDefaultsM3(this.context);
